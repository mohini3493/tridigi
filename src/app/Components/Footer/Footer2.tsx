...
const Footer2 = () => {
  ...
  return (
    <footer
      ...
      data-background="/assets/img/footer_bg_3.jpg"
    >
      <div className="container">
            ...
            <div className="cs_iconbox_wrapper">
              <div className="cs_iconbox cs_style_4">
                ...
                <div className="cs_iconbox_info">
                  <p className="cs_iconbox_subtitle cs_fs_14 cs_white_color_2 cs_mb_1">
                    Office location
                  </p>
                  <p className="cs_iconbox_title cs_fs_20 cs_bold cs_white_color mb-0">
                    4648 Rocky, New York
                  </p>
                </div>
              </div>
              <div className="cs_iconbox cs_style_4">
                ...
                <div className="cs_iconbox_info">
                  ...
                  <a
                    ...
                    className="cs_iconbox_title cs_fs_20 cs_bold cs_white_color"
                  >
                    info@exmple.com
                  </a>
                </div>
          ...
          <div className="cs_footer_row">
            <div className="cs_footer_widget cs_footer_text">
              <div className="cs_text_widget">
                <h2 className="cs_footer_widget_title cs_fs_18 cs_semibold cs_white_color cs_mb_27 position-relative">
                  About Company
                </h2>
            ...
            <div className="cs_footer_links_wrapper">
              <div className="cs_footer_widget">
                ...
                <ul className="cs_footer_menu cs_mp_0">
                  ...
                  <li>
                    <Link href="#" aria-label="Page link">
                      Login / Register
                    </Link>
                  </li>
                </ul>
              ...
              <div className="cs_footer_widget">
                ...
                <div className="cs_img_gallery">
                  <a
                    ...
                    target="_blank"
                    aria-label="Click to visit instagram"
                    className="cs_instagram_thumb cs_center cs_radius_10"
                  >
                    <Image
                      src="/assets/img/instagram_img_1.jpg"
                      alt="img"
                      width={81}
                      height={81}
                    />
                  ...
                  >
                    <Image
                      src="/assets/img/instagram_img_2.jpg"
                      alt="img"
                      width={81}
                      height={81}
                    />
                  ...
                  >
                    <Image
                      src="/assets/img/instagram_img_3.jpg"
                      alt="img"
                      width={81}
                      height={81}
                    />
                  ...
                  >
                    <Image
                      src="/assets/img/instagram_img_4.jpg"
                      alt="img"
                      width={81}
                      height={81}
                    />
                  ...
                  >
                    <Image
                      src="/assets/img/instagram_img_5.jpg"
                      alt="img"
                      width={81}
                      height={81}
                    />
                  ...
                  >
                    <Image
                      src="/assets/img/instagram_img_6.jpg"
                      alt="img"
                      width={81}
                      height={81}
                    />
        ...
        <div className="cs_footer_bottom cs_white_color_2">
          <div className="cs_footer_copyright cs_center">
            &copy; All Copyright 2025 by
