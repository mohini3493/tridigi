        ...
        <div className="cs_hero_content">
          ...
          <div className="cs_hero_text position-relative">
            ...
            <h1 className="cs_hero_title cs_extra_bold wow fadeInDown">
              Digital & Technology{" "}
              <span className="cs_accent_color cs_semibold">Solutions.</span>
            </h1>
            <div className="cs_hero_text_wrapper">
              <p className="cs_hero_text cs_medium wow fadeInRight">
                At TRIVIA Digital Agency, we help ambitious brands grow faster
                with data-driven digital marketing, creative design, and
