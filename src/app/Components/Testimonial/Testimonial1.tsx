...
const Testimonial1 = () => {
  ...
  const testimonialContent = [
    ...
    },
    {
      ...
      title: "Cody Fisher",
      content:
        "This team exceeded my expectations! They were punctual and ssets/imeticulous. My office has looked better. Will use them again!",
    },
    {
      ...
      <div className="container">
        <div className="cs_section_heading cs_style_1 cs_type_1">
          <div className="cs_section_heading_left">
            ...
            <h2 className="cs_fs_48 mb-0 wow fadeInUp">Our Testimonials</h2>
          </div>
